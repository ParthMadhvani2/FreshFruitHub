                        ...
                        <div className="lg:grid md:grid-cols-2">
                            ...
                            <div className="xl:space-y-7 lg:space-y-5 md:space-y-7 space-y-5 sm:mt-0 sm:px-0">
                                ...
                                <h2 className="xl:text-3xl md:text-3xl lg:text-2xl text-2xl font-semibold text-gray-800">
                                    Welcome to Our FreshFruitHub App
                                </h2>
                                {/* Article */}
                                <p className=" text-justify xl:text-base lg:text-sm md:text-base text-sm text-gray-600">
                                    At <strong>FreshFruitHub</strong>, we are committed to providing you with the freshest
                                    ...
                                    Experience the convenience and joy of shopping from the comfort of your home. Join us at <strong>FreshFruitHub</strong> and discover a new way to grocery shop.<br /><br />
